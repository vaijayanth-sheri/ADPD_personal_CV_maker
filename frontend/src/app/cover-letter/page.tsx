...
import { UploadCloud, ArrowLeft, Loader2, FilePlus, FileOutput, CheckCircle2 } from "lucide-react";
...
export default function CoverLetterPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `Generated_Cover_Letter_${company.replace(/\s+/g, '_')}.${format}`;
    ...
    <div className="space-y-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-500 dark:text-zinc-400">
          Provide job details and upload your custom markdown file to generate a personalized cover letter.
        </p>
      </div>
        ...
        {!file && !isUploading && (
          ...
          >
            ...
            <p className="text-sm text-slate-500 dark:text-zinc-400 mb-8 text-center max-w-md">
              Drag and drop your markdown (.md) file containing the content mapped to the job description.
            </p>
